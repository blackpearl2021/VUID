...
% noisyDirName='D:\Continued from 2024\US despeckling experiment\2023 VUID\SynTestSetSigmaLevel\noisyImages\std60';
% VUIDnetOutDirName='D:\Continued from 2024\US despeckling experiment\2023 VUID\SynTestSetSigmaLevel\VUIDnetOutImages\std60';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%   Kodak24 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%   Prepare test dataset   %%%%%%%%%%%%%%%%%%%%%%%%%%
% noisyDirName='D:\Continued from 2024\US despeckling experiment\2023 VUID\SynTestSetKodakSigmaLevel\noisyImages\std60';
% VUIDnetOutDirName='D:\Continued from 2024\US despeckling experiment\2023 VUID\SynTestSetKodakSigmaLevel\VUIDnetOutImages\std60';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%   McMaster %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%   Prepare test dataset   %%%%%%%%%%%%%%%%%%%%%%%%%%
noisyDirName='D:\Continued from 2019\US despeckling experiment\2023 VUID\SynTestSetMcMasterSigmaLevel\noisyImages\std60';
VUIDnetOutDirName='D:\Continued from 2019\US despeckling experiment\2023 VUID\SynTestSetMcMasterSigmaLevel\VUIDnetOutImages\std60';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
DespecklerDirName='D:\Continued from 2019\US despeckling experiment\2023 VUID\VUID_Unet_DnCNN5_TwoInput_sumloss_RecLoss_ResLearning_halfVar6_0327\DenoiserNet';
imdsDespeckler=imageDatastore(DespecklerDirName,FileExtensions=".mat",ReadFcn=@matRead);
SigmaSqDirName='D:\Continued from 2019\US despeckling experiment\2023 VUID\VUID_Unet_DnCNN5_TwoInput_sumloss_RecLoss_ResLearning_halfVar6_0327\SigmaSqNet';
